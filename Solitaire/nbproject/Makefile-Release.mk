...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/solitaire: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/solitaire ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/CardPile.o: src/CardPile.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CardPile.o src/CardPile.cpp
...
${OBJECTDIR}/src/SpecialCardPiles.o: src/SpecialCardPiles.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SpecialCardPiles.o src/SpecialCardPiles.cpp

${OBJECTDIR}/src/Utilidades.o: src/Utilidades.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Utilidades.o src/Utilidades.cpp
...
${OBJECTDIR}/src/miniwin.o: src/miniwin.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/miniwin.o src/miniwin.cpp
